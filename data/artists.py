...
ARTISTS: dict[str, dict] = {
    ...
    "moebius": {
        ...
        "descriptor": "luminous watercolour and airbrushed gradients carrying the whole image, the ink line reduced to a whisper, vast alien vistas in soft atmospheric colour and enormous silent scale",
    },
    "much_cover": {
    ...
    "moebius_comics": {
        ...
        "descriptor": "black clear-line ink held at one uniform weight, flat album colour inside every contour, ruled panel grids and white gutters, visionary science fiction told as European bande dessinee",
    },
    "kentaro_miura": {
        "label": "Kentaro Miura",
        "category": "comics",
    ...
    # --- Fine Art: Northern and Early Renaissance (0.10.0) ---
    "giotto": {
        "label": "Giotto",
        "category": "fine-art",
        "aliases": ["Giotto di Bondone", "proto-Renaissance fresco"],
        "descriptor": "solemn fresco figures with real weight under their robes, modelled in soft earth tone against flat lapis sky, architecture rendered as simple believable volume",
    },
    "jan_van_eyck": {
        "label": "Jan van Eyck",
        "category": "fine-art",
        "aliases": ["Arnolfini", "Flemish primitive", "Early Netherlandish"],
        "descriptor": "jewel-precise Northern oil painting, every hair and thread resolved, deep glazed colour glowing from beneath, cool northern daylight modelling and a convex mirror finish",
    },
    "albrecht_durer": {
        "label": "Albrecht Durer",
        "category": "fine-art",
        "aliases": ["Albrecht Dürer", "Duerer", "German Renaissance engraving"],
        "descriptor": "engraved line of extraordinary discipline, tone built entirely from swelling burin strokes and cross-hatching, watchful symmetry and obsessive naturalistic detail",
    },
    "hans_holbein": {
        "label": "Hans Holbein the Younger",
        "category": "fine-art",
        "aliases": ["Holbein", "Tudor portrait"],
        "descriptor": "cool unflinching portraiture, contour drawn with jeweller's exactness, flat rich ground behind the sitter, fur and gold described in a few exact strokes",
    },

    # --- Fine Art: Baroque and Neoclassical (0.10.0) ---
    "frans_hals": {
        "label": "Frans Hals",
        "category": "fine-art",
        "aliases": ["Dutch Golden Age", "loose brush portrait"],
        "descriptor": "loose slashing brushwork that resolves into likeness at a distance, warm ruddy flesh, black clothing built from visible strokes, ruffs flicked in wet white",
    },
    "nicolas_poussin": {
        "label": "Nicolas Poussin",
        "category": "fine-art",
        "aliases": ["classical landscape", "French classicism"],
        "descriptor": "measured classical composition arranged like a frieze, cool clear light, figures posed in balanced groups, controlled earth-and-blue palette and crisp drawn contour",
    },
    "jacques_louis_david": {
        "label": "Jacques-Louis David",
        "category": "fine-art",
        "aliases": ["Neoclassical history painting", "David"],
        "descriptor": "severe neoclassical staging, sculptural figures lit hard against a plain dark ground, polished enamel-smooth surface and rigorous drawn contour",
    },
    "theodore_gericault": {
        "label": "Theodore Gericault",
        "category": "fine-art",
        "aliases": ["Théodore Géricault", "Gericault", "Romantic realism"],
        "descriptor": "turbulent Romantic drama, muscular bodies in diagonal collapse, storm-dark palette shot through with livid flesh tones and heavy impasto highlights",
    },
    "ilya_repin": {
        "label": "Ilya Repin",
        "category": "fine-art",
        "aliases": ["Russian realism", "Peredvizhniki"],
        "descriptor": "vigorous Russian realist painting, character carried in weathered faces and worn cloth, loaded brushwork over a warm sombre ground",
    },
    "joaquin_sorolla": {
        "label": "Joaquin Sorolla",
        "category": "fine-art",
        "aliases": ["Joaquín Sorolla", "Spanish luminism", "sunlight painter"],
        "descriptor": "dazzling Mediterranean sunlight in loaded wet brushstrokes, violet shadow on white cloth, water broken into flashing highlights and quick confident marks",
    },

    # --- Fine Art: 19th-Century American and British (0.10.0) ---
    "thomas_cole": {
        "label": "Thomas Cole",
        "category": "fine-art",
        "aliases": ["Hudson River School", "allegorical landscape"],
        "descriptor": "grand allegorical landscape, luminous distance receding through golden haze, blasted foreground trees framing a vast theatrical sweep of terrain",
    },
    "frederic_edwin_church": {
        "label": "Frederic Edwin Church",
        "category": "fine-art",
        "aliases": ["Hudson River School", "panoramic landscape"],
        "descriptor": "vast panoramic vistas painted with naturalist precision, incandescent sky colour behind fine detail, atmosphere thickening believably toward the horizon",
    },
    "george_inness": {
        "label": "George Inness",
        "category": "fine-art",
        "aliases": ["Tonalism", "American landscape"],
        "descriptor": "soft tonal landscape dissolved in humid atmosphere, muted green and russet held together by one dominant hue, edges lost in warm mist",
    },
    "winslow_homer": {
        "label": "Winslow Homer",
        "category": "fine-art",
        "aliases": ["American realism", "marine watercolour"],
        "descriptor": "blunt powerful realism, broad wet watercolour washes and hard clean value shapes, cold sea light and figures reduced to solid silhouettes",
    },
    "thomas_eakins": {
        "label": "Thomas Eakins",
        "category": "fine-art",
        "aliases": ["American realism", "anatomical portrait"],
        "descriptor": "unsentimental anatomical realism, sitters modelled in sober brown light, dispassionate observation and perspective worked out with mathematical care",
    },
    "dante_gabriel_rossetti": {
        "label": "Dante Gabriel Rossetti",
        "category": "fine-art",
        "aliases": ["Pre-Raphaelite", "Rossetti"],
        "descriptor": "sensuous Pre-Raphaelite portraiture, one heavy-lidded face filling the frame, saturated jewel colour, dense flowers and hair rendered strand by strand",
    },
    "john_william_waterhouse": {
        "label": "John William Waterhouse",
        "category": "fine-art",
        "aliases": ["Pre-Raphaelite", "Waterhouse"],
        "descriptor": "romantic Pre-Raphaelite figures in soft focus against detailed foliage, cool green shadow, drapery painted with loose confident brushwork",
    },
    "edward_burne_jones": {
        "label": "Edward Burne-Jones",
        "category": "fine-art",
        "aliases": ["Pre-Raphaelite", "Burne-Jones", "Aesthetic Movement"],
        "descriptor": "attenuated dreaming figures in shallow tapestry-flat space, muted gold and slate palette, drapery falling in long unbroken decorative lines",
    },
    "william_morris": {
        "label": "William Morris",
        "category": "fine-art",
        "aliases": ["Arts and Crafts", "Morris and Co", "pattern design"],
        "descriptor": "dense flat repeating pattern of curling stems and stylised flowers, deep indigo, madder and willow-green, every leaf outlined and rhythmically interlocked",
    },
    "charles_rennie_mackintosh": {
        "label": "Charles Rennie Mackintosh",
        "category": "fine-art",
        "aliases": ["Glasgow School", "Mackintosh"],
        "descriptor": "austere vertical linearity broken by a single stylised rose, chalk white and black lacquer, elongated grids and sparse pastel accents",
    },
    "koloman_moser": {
        "label": "Koloman Moser",
        "category": "fine-art",
        "aliases": ["Wiener Werkstatte", "Kolo Moser", "Vienna Secession"],
        "descriptor": "rigorous black-and-white geometric ornament, chequerboard grids and interlocking silhouettes, flat areas of gold against severe rectilinear structure",
    },
    "gustave_moreau": {
        "label": "Gustave Moreau",
        "category": "fine-art",
        "aliases": ["Symbolism", "Moreau"],
        "descriptor": "encrusted Symbolist painting, jewelled impasto detail spreading over dim mythic figures, deep amber and bruise-violet glazes, ornament dissolving into surface",
    },
    "john_james_audubon": {
        "label": "John James Audubon",
        "category": "fine-art",
        "aliases": ["Birds of America", "Audubon"],
        "descriptor": "life-size natural history plate, the specimen posed dramatically across the sheet, hand-coloured aquatint precision and pale unmodelled ground",
    },
    "maria_sibylla_merian": {
        "label": "Maria Sibylla Merian",
        "category": "fine-art",
        "aliases": ["botanical entomology", "Merian"],
        "descriptor": "hand-coloured natural history engraving on vellum, plant and insect entwined in one composition, clear outline and delicate transparent watercolour washes",
    },

    # --- Fine Art: Modernism and the Avant-Garde (0.10.0) ---
    "georges_braque": {
        "label": "Georges Braque",
        "category": "fine-art",
        "aliases": ["Cubism", "Braque", "papier colle"],
        "descriptor": "analytic Cubist facets in muted ochre, grey and umber, planes shuffled shallow against the picture surface, stencilled letters and combed faux-bois texture",
    },
    "paul_signac": {
        "label": "Paul Signac",
        "category": "fine-art",
        "aliases": ["Neo-Impressionism", "Divisionism", "Signac"],
        "descriptor": "mosaic of separate square colour touches, complementary hues vibrating side by side, luminous harbour light built from pure unmixed pigment",
    },
    "henri_rousseau": {
        "label": "Henri Rousseau",
        "category": "fine-art",
        "aliases": ["Le Douanier", "naive painting", "jungle painting"],
        "descriptor": "flat naive painting with every leaf outlined and layered like stage flats, banded greens, hard even light and solemn frontal stillness",
    },
    "umberto_boccioni": {
        "label": "Umberto Boccioni",
        "category": "fine-art",
        "aliases": ["Futurism", "Boccioni"],
        "descriptor": "Futurist force-lines dragging form through space, figures smeared into overlapping repetitions, hot dissonant colour and radiating diagonal energy",
    },
    "robert_delaunay": {
        "label": "Robert Delaunay",
        "category": "fine-art",
        "aliases": ["Orphism", "simultaneous contrast"],
        "descriptor": "concentric discs of pure prismatic colour, simultaneous contrast making each ring vibrate, form dissolved entirely into rhythmic circular colour",
    },
    "natalia_goncharova": {
        "label": "Natalia Goncharova",
        "category": "fine-art",
        "aliases": ["Rayonism", "Russian avant-garde"],
        "descriptor": "Russian avant-garde painting crossing folk icon flatness with splintered rayonist beams, hot red and gold, bold black contour and angular faceting",
    },
    "vladimir_tatlin": {
        "label": "Vladimir Tatlin",
        "category": "fine-art",
        "aliases": ["Constructivism", "counter-relief"],
        "descriptor": "constructivist counter-relief of raw iron, glass and timber, bare material and structural tension shown honestly, spiralling engineered diagonals",
    },
    "theo_van_doesburg": {
        "label": "Theo van Doesburg",
        "category": "fine-art",
        "aliases": ["De Stijl", "Elementarism"],
        "descriptor": "De Stijl composition tipped onto the diagonal, flat primary rectangles bounded by heavy black bands over white, rigorous asymmetric balance",
    },
    "kurt_schwitters": {
        "label": "Kurt Schwitters",
        "category": "fine-art",
        "aliases": ["Merz", "Dada collage"],
        "descriptor": "Merz collage of tram tickets, torn wrappers and printed scraps, muted paper browns and faded reds locked into a taut constructivist grid",
    },
    "wyndham_lewis": {
        "label": "Wyndham Lewis",
        "category": "fine-art",
        "aliases": ["Vorticism", "BLAST"],
        "descriptor": "vorticist mechanical figures cut into hard angular planes, sharp diagonal shafts, cold metallic colour and rigid engineered structure",
    },
    "aleksandr_deyneka": {
        "label": "Aleksandr Deyneka",
        "category": "fine-art",
        "aliases": ["Socialist Realism", "Deineka"],
        "descriptor": "monumental athletic figures in clean simplified planes, bright optimistic sky-blue and red, low viewpoint and wide confident sweeps of flat colour",
    },
    "emile_bernard": {
        "label": "Emile Bernard",
        "category": "fine-art",
        "aliases": ["Émile Bernard", "Cloisonnism", "Pont-Aven"],
        "descriptor": "cloisonnist painting of flat unshaded colour fields fenced by heavy dark contour, like leaded glass laid down in vermilion and deep green",
    },

    # --- Fine Art: Post-War Abstraction (0.10.0) ---
    "franz_kline": {
        "label": "Franz Kline",
        "category": "fine-art",
        "aliases": ["Abstract Expressionism", "black and white gesture"],
        "descriptor": "huge black house-painter strokes slammed across raw white, structural scaffolding of gesture, dry drag and spatter left visible at every edge",
    },
    "barnett_newman": {
        "label": "Barnett Newman",
        "category": "fine-art",
        "aliases": ["colour field", "zip painting"],
        "descriptor": "vast saturated single-colour field split by one narrow vertical zip, matte even surface, scale doing all the work",
    },
    "robert_motherwell": {
        "label": "Robert Motherwell",
        "category": "fine-art",
        "aliases": ["Abstract Expressionism", "Elegies"],
        "descriptor": "heavy black organic masses pressed between white grounds, loaded brush and ragged edges, sombre monumental abstraction with ochre accents",
    },
    "clyfford_still": {
        "label": "Clyfford Still",
        "category": "fine-art",
        "aliases": ["colour field", "Still"],
        "descriptor": "jagged torn-edged fields of thick palette-knife colour, deep oxblood and black split by lightning-shaped slivers of yellow and white",
    },
    "ellsworth_kelly": {
        "label": "Ellsworth Kelly",
        "category": "fine-art",
        "aliases": ["hard-edge painting", "Kelly"],
        "descriptor": "hard-edge painting of one or two flat saturated shapes, immaculate matte surface, curve derived from observed form and reduced to pure colour",
    },
    "victor_vasarely": {
        "label": "Victor Vasarely",
        "category": "fine-art",
        "aliases": ["Op Art", "Vasarely"],
        "descriptor": "optical grid of graded geometric units warping into an illusory bulge, precise flat colour, mechanical repetition producing false depth",
    },
    "jean_tinguely": {
        "label": "Jean Tinguely",
        "category": "fine-art",
        "aliases": ["kinetic sculpture", "meta-matic"],
        "descriptor": "kinetic assemblage of rusted wheels, belts and scrap steel welded into an absurd machine, matte black paint and visible mechanical linkage",
    },
    "karel_appel": {
        "label": "Karel Appel",
        "category": "fine-art",
        "aliases": ["CoBrA", "Appel"],
        "descriptor": "CoBrA painting of childlike creatures in raw squeezed colour, thick uninhibited impasto, black outline scrawled over screaming red, blue and yellow",
    },
    "sigmar_polke": {
        "label": "Sigmar Polke",
        "category": "fine-art",
        "aliases": ["Capitalist Realism", "raster dots"],
        "descriptor": "enlarged printing raster dots layered over patterned fabric grounds, chemical stains and translucent pours, deliberate collision of image and material",
    },
    "francesco_clemente": {
        "label": "Francesco Clemente",
        "category": "fine-art",
        "aliases": ["Transavantgarde", "Clemente"],
        "descriptor": "dreamlike figures in chalky fresco-soft pigment, thin washed colour, symbolic body fragments floating in shallow undefined space",
    },
    "richard_estes": {
        "label": "Richard Estes",
        "category": "fine-art",
        "aliases": ["Photorealism", "Estes"],
        "descriptor": "photorealist painting of plate glass and chrome, layered reflections resolved sharply everywhere at once, cool even daylight and clean saturated hue",
    },
    "shoji_hamada": {
        "label": "Shoji Hamada",
        "category": "fine-art",
        "aliases": ["Mingei", "Mashiko pottery"],
        "descriptor": "unassuming stoneware with thick ash and iron glaze, broad confident brushed strokes across the belly, warm earth colour pooling in the throw marks",
    },

    # --- Fine Art: American Regionalism and the Ashcan School (0.10.0) ---
    "robert_henri": {
        "label": "Robert Henri",
        "category": "fine-art",
        "aliases": ["Ashcan School", "Henri"],
        "descriptor": "swift alla prima portraiture in dark loaded strokes, ruddy warm flesh emerging from a dim ground, brush marks left frankly visible",
    },
    "george_bellows": {
        "label": "George Bellows",
        "category": "fine-art",
        "aliases": ["Ashcan School", "Bellows"],
        "descriptor": "muscular urban realism, bodies wrenched into violent motion under harsh artificial light, slabbed dark paint and glaring pale highlights",
    },
    "grant_wood": {
        "label": "Grant Wood",
        "category": "fine-art",
        "aliases": ["Regionalism", "American Gothic"],
        "descriptor": "smooth enamel-hard Regionalist painting, rounded stylised forms and neat clipped detail, cool midwestern light and severe frontal symmetry",
    },
    "thomas_hart_benton": {
        "label": "Thomas Hart Benton",
        "category": "fine-art",
        "aliases": ["Regionalism", "Benton"],
        "descriptor": "restless Regionalist murals of rippling elongated figures, forms bulging and twisting in rhythmic S-curves, hot earth palette and sculpted modelling",
    },

    # --- Illustration: Golden Age and Poster Design (0.10.0) ---
    "am_cassandre": {
        "label": "A.M. Cassandre",
        "category": "illustration",
        "aliases": ["Cassandre", "Art Deco poster", "Dubonnet"],
        "descriptor": "Art Deco poster geometry, monumental forms flattened into simple airbrushed planes, dramatic low viewpoint and integrated hand-drawn lettering",
    },
    "ludwig_hohlwein": {
        "label": "Ludwig Hohlwein",
        "category": "illustration",
        "aliases": ["Sachplakat", "German poster"],
        "descriptor": "bold object poster with flat silhouetted masses, restricted warm palette, textured mottled fills and heavy confident shape-first composition",
    },
    "walter_crane": {
        "label": "Walter Crane",
        "category": "illustration",
        "aliases": ["Arts and Crafts illustration", "Crane"],
        "descriptor": "decorative outlined illustration in the Arts and Crafts manner, flat pattern filling every background, ornamental borders and clear even colour",
    },
    "kate_greenaway": {
        "label": "Kate Greenaway",
        "category": "illustration",
        "aliases": ["Greenaway", "Regency children's illustration"],
        "descriptor": "delicate pastel children's illustration, soft watercolour washes over fine outline, muted sage and rose, generous white space around each figure",
    },
    "randolph_caldecott": {
        "label": "Randolph Caldecott",
        "category": "illustration",
        "aliases": ["Caldecott", "Victorian picture book"],
        "descriptor": "lively economical pen line with light watercolour tint, movement caught in a few strokes, warm cream paper showing through everywhere",
    },
    "eh_shepard": {
        "label": "E.H. Shepard",
        "category": "illustration",
        "aliases": ["Shepard", "Winnie-the-Pooh", "Wind in the Willows"],
        "descriptor": "tender scratchy pen-and-ink line, gentle hatching for shade, unpretentious character drawing on warm untouched paper",
    },
    "wanda_gag": {
        "label": "Wanda Gag",
        "category": "illustration",
        "aliases": ["Wanda Gág", "Millions of Cats"],
        "descriptor": "rolling black-and-white lithographic illustration, swirling repetitive rhythm across the page, soft velvety crayon tone and dense pattern",
    },
    "charles_dana_gibson": {
        "label": "Charles Dana Gibson",
        "category": "illustration",
        "aliases": ["Gibson Girl", "Gibson"],
        "descriptor": "confident pen-and-ink line drawing, tone built purely from parallel hatching, crisp whites and elegant turn-of-the-century social caricature",
    },
    "grandville": {
        "label": "J.J. Grandville",
        "category": "illustration",
        "aliases": ["Grandville", "Un Autre Monde"],
        "descriptor": "engraved satirical fantasy where objects and animals take human posture, dense fine hatching, dreamlike transformation rendered with deadpan precision",
    },
    "mervyn_peake": {
        "label": "Mervyn Peake",
        "category": "illustration",
        "aliases": ["Peake", "Gormenghast"],
        "descriptor": "spidery nervous pen line describing gaunt grotesque figures, deep smudged shadow and a haunted lopsided sense of anatomy",
    },
    "rene_gruau": {
        "label": "Rene Gruau",
        "category": "illustration",
        "aliases": ["René Gruau", "fashion illustration", "Dior illustration"],
        "descriptor": "sweeping brush-drawn fashion line, one flat vermilion or black shape carrying the whole figure, elegant economy and dramatic negative space",
    },
    "jj_sempe": {
        "label": "Jean-Jacques Sempe",
        "category": "illustration",
        "aliases": ["Jean-Jacques Sempé", "Sempe", "New Yorker cover"],
        "descriptor": "tiny figures adrift in vast delicately washed space, feathery ink line and pale watercolour, gentle observational humour of scale",
    },
    "virgil_finlay": {
        "label": "Virgil Finlay",
        "category": "illustration",
        "aliases": ["Finlay", "pulp stipple", "Weird Tales"],
        "descriptor": "obsessive stippled scratchboard illustration, tone built from millions of dots and lathe lines, luminous figures against deep engraved black",
    },
    "chesley_bonestell": {
        "label": "Chesley Bonestell",
        "category": "illustration",
        "aliases": ["space art", "astronomical illustration"],
        "descriptor": "cold precise astronomical painting, airless hard-edged shadow, rocky terrain rendered with architectural realism under a black star-flecked sky",
    },

    # --- Comics: Newspaper Strip and Adventure (0.10.0) ---
    "george_herriman": {
        "label": "George Herriman",
        "category": "comics",
        "aliases": ["Krazy Kat", "Herriman"],
        "descriptor": "poetic scratchy brush line with shifting dreamlike backdrops, bold black shapes, hand-lettered whimsy and playfully unstable panel geometry",
    },
    "alex_raymond": {
        "label": "Alex Raymond",
        "category": "comics",
        "aliases": ["Flash Gordon", "Rip Kirby"],
        "descriptor": "elegant adventure-strip brushwork, feathered ink modelling on idealised anatomy, ornate art deco design and glossy black-and-white finish",
    },
    "milton_caniff": {
        "label": "Milton Caniff",
        "category": "comics",
        "aliases": ["Terry and the Pirates", "Steve Canyon"],
        "descriptor": "cinematic chiaroscuro brush inking, heavy black shadow masses shaping the frame, terse realistic figures and dramatic staged lighting",
    },
    "burne_hogarth": {
        "label": "Burne Hogarth",
        "category": "comics",
        "aliases": ["Tarzan", "dynamic anatomy"],
        "descriptor": "hyper-dynamic anatomy in extreme foreshortening, muscles rendered as swirling interlocked forms, whipping contour and explosive diagonal energy",
    },
    "jack_davis": {
        "label": "Jack Davis",
        "category": "comics",
        "aliases": ["EC Comics", "MAD magazine"],
        "descriptor": "loose rubbery cartooning with frantic scratchy ink line, bulging eyes and huge feet, warm broad comic colour and gleeful crowded chaos",
    },
    "andre_franquin": {
        "label": "Andre Franquin",
        "category": "comics",
        "aliases": ["André Franquin", "Gaston Lagaffe", "Marsupilami"],
        "descriptor": "supple elastic Franco-Belgian cartooning, line swelling and snapping with motion, bright flat album colour and gleefully cluttered staging",
    },
    "albert_uderzo": {
        "label": "Albert Uderzo",
        "category": "comics",
        "aliases": ["Asterix", "Uderzo"],
        "descriptor": "rounded exuberant cartoon figures with expressive noses, clean confident outline, flat bright album colour and dense comic crowd scenes",
    },
    "jean_claude_mezieres": {
        "label": "Jean-Claude Mezieres",
        "category": "comics",
        "aliases": ["Jean-Claude Mézières", "Valerian", "Mezieres"],
        "descriptor": "inventive science-fiction bande dessinee, organic alien design over clear ink linework, warm saturated flat colour and generous world-building detail",
    },
    "barry_windsor_smith": {
        "label": "Barry Windsor-Smith",
        "category": "comics",
        "aliases": ["Conan", "BWS"],
        "descriptor": "ornate art-nouveau comic drawing, fine engraved hatching and decorative border motifs, muted painterly colour over meticulously stylised anatomy",
    },
    "hiromu_arakawa": {
        "label": "Hiromu Arakawa",
        "category": "comics",
        "aliases": ["Fullmetal Alchemist", "Arakawa"],
        "descriptor": "sturdy expressive manga linework with grounded believable anatomy, clean screentone shading and warm broad comedy breaking into hard action",
    },
    "yoshihiro_tatsumi": {
        "label": "Yoshihiro Tatsumi",
        "category": "comics",
        "aliases": ["gekiga", "Tatsumi"],
        "descriptor": "spare gekiga linework, flat grey tone and blank stares, mundane framing and a cramped low-key drawing style that carries quiet desperation",
    },
    "jiro_taniguchi": {
        "label": "Jiro Taniguchi",
        "category": "comics",
        "aliases": ["Taniguchi", "The Walking Man"],
        "descriptor": "calm precise manga draughtsmanship, patient architectural detail rendered in even fine line, quiet pacing and clear undramatic light",
    },
    "moto_hagio": {
        "label": "Moto Hagio",
        "category": "comics",
        "aliases": ["Year 24 Group", "shojo pioneer"],
        "descriptor": "lyrical shojo drawing with huge starred eyes, layered floating panels breaking their borders, delicate screentone and decorative floral ground",
    },
    "tsutomu_nihei": {
        "label": "Tsutomu Nihei",
        "category": "comics",
        "aliases": ["BLAME", "Nihei"],
        "descriptor": "vast brutalist architecture drawn in dense hatched black, tiny figures lost in endless concrete scale, cold silence and hard mechanical detail",
    },

    # --- Film: Directors and Cinematographers (0.10.0) ---
    "orson_welles": {
        "label": "Orson Welles",
        "category": "film",
        "aliases": ["Citizen Kane", "deep focus"],
        "descriptor": "deep-focus black-and-white composition with ceilings in frame, extreme low angles, hard shafts of light and heavy expressionist shadow",
    },
    "fritz_lang": {
        "label": "Fritz Lang",
        "category": "film",
        "aliases": ["Metropolis", "M"],
        "descriptor": "geometric expressionist staging, crowds arranged into rigid ornamental patterns, hard-edged shadow and monumental machine-age design",
    },
    "fw_murnau": {
        "label": "F.W. Murnau",
        "category": "film",
        "aliases": ["Nosferatu", "Sunrise", "Murnau"],
        "descriptor": "silent expressionist imagery of distorted shadow and unmoored camera, high-contrast monochrome and looming stylised silhouettes",
    },
    "jean_luc_godard": {
        "label": "Jean-Luc Godard",
        "category": "film",
        "aliases": ["Breathless", "Godard", "Nouvelle Vague"],
        "descriptor": "loose handheld natural-light framing, jump-cut abruptness, flat primary colour blocks and printed text slammed across the image",
    },
    "francois_truffaut": {
        "label": "Francois Truffaut",
        "category": "film",
        "aliases": ["François Truffaut", "400 Blows", "Truffaut"],
        "descriptor": "warm humane framing with restless mobile camera, soft available light, unpolished spontaneity and tender observational close-ups",
    },
    "michelangelo_antonioni": {
        "label": "Michelangelo Antonioni",
        "category": "film",
        "aliases": ["L'Avventura", "Red Desert"],
        "descriptor": "figures dwarfed by cool architectural emptiness, painted industrial colour, long static holds and alienated off-centre composition",
    },
    "robert_bresson": {
        "label": "Robert Bresson",
        "category": "film",
        "aliases": ["Bresson", "Pickpocket"],
        "descriptor": "austere framing on hands and objects, flat undramatic light, blank faces and precise ascetic cutting stripped of performance",
    },
    "jean_pierre_melville": {
        "label": "Jean-Pierre Melville",
        "category": "film",
        "aliases": ["Le Samourai", "Melville"],
        "descriptor": "cold blue-grey minimalist crime imagery, immaculate empty interiors, trench-coated silhouettes and clinical restrained camera moves",
    },
    "luis_bunuel": {
        "label": "Luis Bunuel",
        "category": "film",
        "aliases": ["Luis Buñuel", "Bunuel", "surrealist cinema"],
        "descriptor": "deadpan surrealist imagery presented in plain functional framing, dream logic delivered with bourgeois politeness and flat even light",
    },
    "jacques_tati": {
        "label": "Jacques Tati",
        "category": "film",
        "aliases": ["Playtime", "Monsieur Hulot"],
        "descriptor": "wide deep-focus comic tableaux with several gags running at once, pale modernist colour, geometric glass architecture and tiny precise human motion",
    },
    "kenji_mizoguchi": {
        "label": "Kenji Mizoguchi",
        "category": "film",
        "aliases": ["Ugetsu", "Mizoguchi"],
        "descriptor": "long flowing crane shots holding a whole scene, elegant scroll-like lateral composition, misted greys and restrained classical distance",
    },
    "satyajit_ray": {
        "label": "Satyajit Ray",
        "category": "film",
        "aliases": ["Apu Trilogy", "Ray"],
        "descriptor": "humanist black-and-white realism in soft natural light, patient framing on faces, textures of cloth and rain rendered with quiet attention",
    },
    "michael_powell": {
        "label": "Michael Powell",
        "category": "film",
        "aliases": ["Powell and Pressburger", "The Archers", "Red Shoes"],
        "descriptor": "delirious saturated Technicolor fantasy, painted theatrical backdrops, bold unnatural colour keys and lavish stylised design",
    },
    "steven_spielberg": {
        "label": "Steven Spielberg",
        "category": "film",
        "aliases": ["Spielberg", "blockbuster"],
        "descriptor": "warm backlit wonder with shafts of haze, faces tilting up into off-screen light, fluid dolly moves and clean readable blockbuster staging",
    },
    "lars_von_trier": {
        "label": "Lars von Trier",
        "category": "film",
        "aliases": ["von Trier", "Dogme 95", "Melancholia"],
        "descriptor": "raw handheld immediacy with harsh available light, desaturated grain and abrupt framing, or else glacial hyper-composed tableaux",
    },
    "michael_haneke": {
        "label": "Michael Haneke",
        "category": "film",
        "aliases": ["Haneke", "Cache", "Amour"],
        "descriptor": "cold static wide framing held far too long, flat unforgiving natural light, clinical symmetry and pitiless observational distance",
    },
    "coen_brothers": {
        "label": "Joel and Ethan Coen",
        "category": "film",
        "aliases": ["Coen Brothers", "Fargo", "Barton Fink"],
        "descriptor": "precise symmetrical framing with wide-angle character distortion, stylised regional colour palettes and deadpan meticulous production design",
    },
    "paul_thomas_anderson": {
        "label": "Paul Thomas Anderson",
        "category": "film",
        "aliases": ["PTA", "There Will Be Blood"],
        "descriptor": "long roaming Steadicam takes, warm period-accurate colour, faces held in close intimate framing against grand sparse spaces",
    },
    "denis_villeneuve": {
        "label": "Denis Villeneuve",
        "category": "film",
        "aliases": ["Villeneuve", "Arrival", "Dune"],
        "descriptor": "monumental hazy scale, silhouettes dwarfed by vast simple forms, muted ochre and grey palette and slow deliberate symmetrical framing",
    },
    "alfonso_cuaron": {
        "label": "Alfonso Cuaron",
        "category": "film",
        "aliases": ["Alfonso Cuarón", "Cuaron", "Children of Men"],
        "descriptor": "long unbroken handheld takes moving through the action, naturalistic available light, cool desaturated palette and immersive documentary proximity",
    },
    "pedro_almodovar": {
        "label": "Pedro Almodovar",
        "category": "film",
        "aliases": ["Pedro Almodóvar", "Almodovar"],
        "descriptor": "melodrama in blazing saturated colour, walls of vermilion and cobalt behind the figure, pop-art production design and glossy immaculate lighting",
    },
    "park_chan_wook": {
        "label": "Park Chan-wook",
        "category": "film",
        "aliases": ["Oldboy", "The Handmaiden", "Park"],
        "descriptor": "lush painterly colour with immaculate symmetrical framing, ornate production design, sliding camera moves and lacquered high-gloss surfaces",
    },
    "jack_cardiff": {
        "label": "Jack Cardiff",
        "category": "film",
        "aliases": ["Technicolor cinematography", "Black Narcissus"],
        "descriptor": "three-strip Technicolor luminosity, glowing skin tones against jewel-saturated sets, painterly key light modelled after old master portraits",
    },
    "conrad_hall": {
        "label": "Conrad Hall",
        "category": "film",
        "aliases": ["Hall", "Road to Perdition", "Butch Cassidy"],
        "descriptor": "expressive naturalism with pools of shadow and single practical sources, silvery desaturated palette and rain-lit reflective surfaces",
    },
    "nestor_almendros": {
        "label": "Nestor Almendros",
        "category": "film",
        "aliases": ["Néstor Almendros", "Days of Heaven", "magic hour"],
        "descriptor": "available-light naturalism shot at the edge of dusk, warm low sun raking across the frame, soft unfussy exposure and delicate skin rendering",
    },
    "darius_khondji": {
        "label": "Darius Khondji",
        "category": "film",
        "aliases": ["Khondji", "Se7en", "Delicatessen"],
        "descriptor": "dense underexposed imagery with sickly amber-green cast, heavy grain and bleach-bypassed contrast, texture crawling through the shadows",
    },

    # --- Photography: Street and Studio (0.10.0) ---
    "helen_levitt": {
        "label": "Helen Levitt",
        "category": "photography",
        "aliases": ["Levitt", "New York street"],
        "descriptor": "tender candid street photography of children at play, gestural black-and-white framing, chalk marks and stoops in soft available light",
    },
    "lisette_model": {
        "label": "Lisette Model",
        "category": "photography",
        "aliases": ["Model", "Fifth Avenue"],
        "descriptor": "close confrontational black-and-white portraits shot from low down, harsh grain and blunt cropping, bodies rendered large and unvarnished",
    },
    "robert_doisneau": {
        "label": "Robert Doisneau",
        "category": "photography",
        "aliases": ["Doisneau", "Parisian street"],
        "descriptor": "warm humorous Parisian street photography, soft grey monochrome, everyday gesture caught with affectionate perfectly timed framing",
    },
    "malick_sidibe": {
        "label": "Malick Sidibe",
        "category": "photography",
        "aliases": ["Malick Sidibé", "Bamako studio", "Sidibe"],
        "descriptor": "joyful black-and-white studio portraits against bold striped cloth backdrops, direct flash, dancing subjects and confident patterned dress",
    },
    "seydou_keita": {
        "label": "Seydou Keita",
        "category": "photography",
        "aliases": ["Seydou Keïta", "Bamako portrait", "Keita"],
        "descriptor": "formal Malian studio portraits on richly patterned textile grounds, sitter posed frontally with props, luminous even monochrome tone",
    },
    "james_van_der_zee": {
        "label": "James Van Der Zee",
        "category": "photography",
        "aliases": ["Van Der Zee", "Harlem Renaissance photography"],
        "descriptor": "dignified Harlem studio portraiture with painted backdrops and retouched glowing skin, careful posing and soft glamorous key light",
    },
    "roy_decarava": {
        "label": "Roy DeCarava",
        "category": "photography",
        "aliases": ["DeCarava", "The Sweet Flypaper of Life"],
        "descriptor": "luminous low-key black-and-white printing that lives in the shadows, deep velvety greys, quiet intimate framing of everyday life",
    },

    # --- Digital / Concept (0.10.0) ---
    "yoji_shinkawa": {
        "label": "Yoji Shinkawa",
        "category": "digital",
        "aliases": ["Shinkawa", "Metal Gear design"],
        "descriptor": "sweeping sumi brush concept art, mechanical forms blocked in with dry drag and splatter, sparse ink washes and confident calligraphic gesture",
    },
    "peter_mohrbacher": {
        "label": "Peter Mohrbacher",
        "category": "digital",
