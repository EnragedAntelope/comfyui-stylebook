 ...
 * specifier (local imports like ./stylebook_data.js, Node built-ins) passes
 * through to nextResolve untouched -- this stubs ComfyUI's frontend API,
 * not the module system, so the real js/*.js files run completely
 * unmodified.
 *
